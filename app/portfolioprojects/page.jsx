...
const projects = [
  ...
  { id: "38", members: [{ username: "emmanuelist", avatarUrl: "https://avatars.githubusercontent.com/emmanuelist" }], description: "Know Your Coin History: A privacy-first bitcoin transaction ancestry explorer with interactive graph visualization, BIP-329 labeling, and eight wallet fingerprinting heuristics. Powered by your own node.", repoUrl: "https://github.com/emmanuelist/kych-explorer" },
  { id: "39", members: [{ username: "mutatrum", avatarUrl: "https://avatars.githubusercontent.com/mutatrum" }], description: "Educational resource explaining the Lightning Network. Inspired by Learn Me a Bitcoin. Aims to make the Lightning Network accessible to everyone through clear explanations, interactive tools, visual diagrams, and progressive difficulty.", repoUrl: "https://github.com/learn-me-a-lightning/learn-me-a-lightning" },
  { id: "40", members: [{ username: "mutatrum", avatarUrl: "https://avatars.githubusercontent.com/mutatrum" }], description: "Automated Lightning Network channel manager for batch channel opens with rejection tracking.", repoUrl: "https://github.com/mutatrum/oatt" },
  { id: "41", members: [{ username: "mutatrum", avatarUrl: "https://avatars.githubusercontent.com/mutatrum" }], description: "Early-access release of ESP-Miner, the firmware for Bitaxe miners. This release merges many open PRs into a single testing firmware, making it easier for testers to perform QA.", repoUrl: "https://github.com/bitaxeorg/ESP-Miner/releases/tag/early-access-2026-03" },
  { id: "42", members: [{ username: "xstoicunicornx", avatarUrl: "https://avatars.githubusercontent.com/xstoicunicornx" }], description: "Node.js Payjoin v2 (BIP-77) demo that proves the JavaScript bindings in the Payjoin Dev Kit.", repoUrl: "https://github.com/xstoicunicornx/node_payjoin/" },
  { id: "43", members: [{ username: "esixce", avatarUrl: "https://avatars.githubusercontent.com/esixce" }], description: "Conduit: Peer-to-peer system where paying a Lightning invoice atomically reveals the decryption key for digital content.", repoUrl: "https://github.com/conduitp2p/conduit" },
  { id: "44", members: [{ username: "esixce", avatarUrl: "https://avatars.githubusercontent.com/esixce" }], description: "Small, focused apps for learning how bitcoin is serialized and how Bitcoin Core is structured.", repoUrl: "https://github.com/Bitcoineando/" },
  { id: "45", members: [{ username: "beihaili", avatarUrl: "https://avatars.githubusercontent.com/beihaili" }], description: "Stories About Bitcoin: Bitcoin's history, told as literature — not textbook. A bilingual (Chinese/English) book covering 1976–2025 in 39 chapters.", repoUrl: "https://github.com/beihaili/Stories-about-Bitcoin" },
  { id: "46", members: [{ username: "8144225309", avatarUrl: "https://avatars.githubusercontent.com/8144225309" }], description: "anchorwatch: P2A anchor fee-bumping service paid with Lightning. Monitors the bitcoin mempool for transactions with P2A (Pay-to-Anchor) outputs and offers CPFP fee bumping as a paid service.", repoUrl: "https://github.com/8144225309/anchorwatch" },
  { id: "47", members: [{ username: "OWK50GA", avatarUrl: "https://avatars.githubusercontent.com/OWK50GA" }], description: "Hoover: A watch-only bitcoin CLI tool that identifies dust attack UTXOs and sweeps them away — without revealing address linkage.", repoUrl: "https://github.com/OWK50GA/hoover" },
  { id: "48", members: [{ username: "Abeeujah", avatarUrl: "https://avatars.githubusercontent.com/Abeeujah" }], description: "Rust implementation of the Secure Fountain (SeF) architecture for slashing blockchain storage costs using Luby Transform (LT) fountain codes. Full nodes store only a small fraction of coded droplets per epoch instead of the entire blockchain, enabling lightweight chain reconstruction via error-resilient peeling decoders.", repoUrl: "https://github.com/Abeeujah/sef" },
  { id: "49", members: [{ username: "Abeeujah", avatarUrl: "https://avatars.githubusercontent.com/Abeeujah" }], description: "High-performance bitcoin mempool query engine with real-time fee estimation over gRPC and shared memory.", repoUrl: "https://github.com/Abeeujah/memq" },
  { id: "50", members: [{ username: "Jolah1", avatarUrl: "https://avatars.githubusercontent.com/Jolah1" }], description: "CLI tool that detects dust attack UTXOs in your wallet and sweeps them safely using PSBTs", repoUrl: "https://github.com/Jolah1/dust-cleaner" },
  { id: "51", members: [{ username: "UfiairENE", avatarUrl: "https://avatars.githubusercontent.com/UfiairENE" }], description: "A Go implementation of BIP-353: DNS Payment Instructions.", repoUrl: "https://github.com/btc-go/bip353" },
  { id: "52", members: [{ username: "weikengchen", avatarUrl: "https://avatars.githubusercontent.com/weikengchen" }], description: "Private information retrieval (PIR) for Bitcoin UTXO set.", repoUrl: "https://github.com/Bitcoin-PIR/Bitcoin-PIR" },
  { id: "53", members: [{ username: "BOSS program participants"}], description: "Community organized cryptography study group", repoUrl: "https://github.com/RazorBest/Bitcoin-Cryptography-Study-Group" },
];
